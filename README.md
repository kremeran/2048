...
2. You can now technically perform most of the basic game movements but there are some apparent issues. Restarting the game (r) occationally causes you to start with a score of 1 or 2 when you should start with 0.
